    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex m-2 p-2">
                <a href="{{ route("admin.reservations.index") }}" class="px-4 py-2 bg-indigo-500 hover:bg-ingigo-700 rounded-lg">Reservation Index
                </a>
            </div>
                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('admin.reservations.update' , $reservation->id) }}">
                        ...
                        <div class="sm:col-span-6 pt-5">
                            ...
                            <div class="mt-1">
                               <select name="table_id" id="table_id" class="block w-full transition duration-150 ease-in-out appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" style="width: 100%">
                                @foreach ($tables as $table)
                                <option value="{{ $table->id }}" @selected($table->id == $reservation->table->id)>{{ $table->name }} ({{ $table->guest_number }} Guest)</option>
                        ...
                        <div class="mt-6 p-4">
                            <button type="submit" class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg" style="background-color: gray; color:aliceblue" >Update</button>
