        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex m-2 p-2">
                <a href="{{ route('admin.reservations.index') }}"
                    class="px-4 py-2 bg-indigo-500 hover:bg-ingigo-700 rounded-lg p-3 mb-2 bg-primary text-white">Reservation
                    Index
                </a>
            </div>
                    ...
                    <form method="POST" action="{{ route('admin.reservations.store') }}">
                        ...
                        <div class="mt-6 p-4">
                            <button type="submit" class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg"
                                style="background-color: gray; color:aliceblue">Store</button>
