    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex m-2 p-2">
                <a href="{{ route("admin.categories.index") }}" class="px-4 py-2 bg-indigo-500 hover:bg-ingigo-700 rounded-lg p-3 mb-2 bg-primary text-white">Category Index
                </a>
            </div>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="text" id="name"  name="name"
                                    class="block w-full t appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('name') border-red-400 @enderror" />
                            </div>
                            @error('name')
